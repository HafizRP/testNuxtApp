<template>
  ...
  <section id="body" class="container mx-auto dark:bg-gray-900">
    <VeeForm class="px-4" :validation-schema="schema" as="div" v-slot="{ errors, handleSubmit, isSubmitting }">
      <form @submit="handleSubmit($event, createUser)">
        ...
        <div class="mb-2">
          ...
          <Field name="username" type="text" id="username" placeholder="Username" :class="[
            { 'border-red-700': typeof errors.username !== 'undefined' },
        ...
        <div class="mb-2">
          ...
          <Field name="password" type="password" id="password" placeholder="Password" :class="[
            { 'border-red-700': typeof errors.password !== 'undefined' },
            'bg-gray-50 border border-gray-300  border-2 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white',
          ]" />
    ...
    <div class="mt-10 pb-10" id="users">
      <div id="user-button">
        <button class="bg-blue-600 px-6 py-2 text-white rounded-md" @click="refresh()">
          Refresh
        </button>
      </div>
      <div class="relative overflow-x-auto" v-if="!pending">
        <table class="w-full text-sm text-gray-500 dark:text-gray-400 text-center">
          ...
          <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="(user, i) in users" :key="i">
