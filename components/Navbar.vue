    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"> {{ typeof user }}</span>
            </a>
            <div class="flex md:order-2">
                <a type="button" href="/login" v-if="!user"
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                ...
                <ul
                    ...
                    <li>
                        <NuxtLink to="/" :class="[{ 'text-blue-600': $route.name == 'index' }, 'nav-item']">
                            Home
                        </NuxtLink>
                    </li>
                    <li>
                        <NuxtLink to="/users" :class="[{ 'text-blue-600': $route.name == 'users' }, 'nav-item']">
                            About
                        </NuxtLink>
                    </li>
                    <li>
